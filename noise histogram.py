...
plt.plot(intensity, label= 'intensity', alpha= 0.3) #, color= 'c'
plt.plot(net, label= 'net', alpha= 0.6) #, color= 'y'
plt.legend()
...
plt.hist(background, 50, alpha= 0.4, label= 'background')
plt.hist(intensity, 50, alpha= 0.3, label= 'internsity')
plt.hist(net, 50, alpha= 0.6, label= 'net')
plt.legend()
